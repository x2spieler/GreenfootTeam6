...
public abstract class ScrollActor extends Actor {
	...
	/**
	 * Returns the x coordinate where you're really standing.
	 */
	...
	/**
	 * Returns the y coordinate where you're really standing.
	 */
	...
	/**
	 * Sets your location seen from the world (regular location). That means
	 * that a negative location is off screen, and bigger than the world's size
	 * is also off screen.
	 */
	...
	/**
	 * Sets your location in the big space (the space where the camera is moving
	 * over).
	 */
	...
	/**
	 * Returns the ScrollWorld you're in. If you're not in a world, this will
	 * return null.
	 */
	...
	/**
	 * Moves the scroll actor forward a specified amount. To go backwards, enter
	 * a negative number.
	 * <p>
	 * This will affect all the locations of the scroll actor.
	 * 
	 * @param distance
	 *            The number of cells the scroll actor will move forward.
	 */
	...
	/**
	 * Returns you're a camera follower or not. If you're not in a world, this
