 ...
 * location starts as x=half width, y=half height of the world. It can't get
 * outside of the big space.
 * <p>
 * 
 * The background is always scrolling, you don't have to do anything for it.
 * Just make a background like you always do in your scenarios, and this
 * scenario will scroll over it. The only note is that the method
 * {@link setBackground} is replaced by {@link setNewBackground}.
 * <p>
 * 
...
public abstract class ScrollWorld extends World {
	 ...
	 * 
	 * @param width
	 *            The width of the scroll world in cells.
	 * @param height
	 *            The height of the scroll world in cells.
	 * @param cellSize
	 *            The size of the cells (in pixels).
	 * @param fullWidth
	 *            The total width of the world. That means, objects can't move
	 *            further than this limit.
	 * @param fullHeight
	 *            The total height of the world. That means, objects can't move
	 *            further than this limit.
	...
	/**
	 * Adds an object which will follow the camera. The location is seen from
	 * the camera, not from the big space.
	 * 
	 * @param cameraFollower
	 ...
	 * 
	 * @param object
	 *            The object that will be removed from the world. This can
	 *            either be a camera follower, or just a regular object.
	 */
	...
	/**
	 * Moves the camera to a particular location. Note that this is a location
	 * in the big space.
	 * 
	 * @param x
	...
	/**
	 * Sets the direction the camera is facing. It doesn't change anything you
	 * see, but it makes it possible to use the {@link moveCamera} method.
	 * 
	 * @param degrees
	...
	/**
	 * Turns the camera. It doesn't change anything you see, but it makes it
	 * possible to use the {@link moveCamera} method.
	 * 
	 * @param amount
	 *            The number of degrees the camera will turn clockwise. If this
	 *            is negative, it will turn counter-clockwise.
	...
	/**
	 * Moves the camera forward to the direction it's facing (to go backwards,
	 * enter a negative number).
	 * 
	 * @param amount
	 *            The number of cells the camera will move. When this is
	 *            negative, the camera will move forward.
	 */
