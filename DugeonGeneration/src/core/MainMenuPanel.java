...
public class MainMenuPanel extends BackgroundPanel {
	...
	public MainMenuPanel(final ActionListener start, final ActionListener highscore, DungeonMap dm) {
		super(new ImageIcon(MainMenuPanel.class.getClassLoader().getResource("images/background/Background.jpg"))
				.getImage());
		...
		GameStart.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				GameStart.setIcon(
						new ImageIcon(MainMenuPanel.class.getResource("/images/background/Game-Start-white.png")));
			}
		...
		eingeben.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				eingeben.setIcon(
						new ImageIcon(MainMenuPanel.class.getResource("/images/background/new-seed-white.png")));
			}
		...
		HighScore.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				HighScore.setIcon(
						new ImageIcon(MainMenuPanel.class.getResource("/images/background/High-Score-white.png")));
			}
