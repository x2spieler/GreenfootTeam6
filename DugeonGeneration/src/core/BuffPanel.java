...
public class BuffPanel extends JPanel 
{
	...
	public BuffPanel(String text)
	{
		...
		BufferedImage img=loadImage("src/images/hud/flask_empty.png");
		...
		substanceImg=loadImage("src/images/hud/flask_substance.png");
	...
	public void updateFlask(double percent)
	{
		...
		if(height<=0)
			height=1;
		BufferedImage subImage=substanceImg.getSubimage(0, substanceImg.getHeight()-height, substanceImg.getWidth(), height);
