...
public class HouseTileLoader implements ITileLoader {
	...
	private ITileBlock getDoubleCornerRight() {
		return new TileBlock(3, 3, findTile("UpperLeftInnerCorner11"), null, null, findTile("DoubleCornerRight11"), findTile("DoubleCornerRight12"), null, findTile("DoubleCornerRight21"), findTile("DoubleCornerRight22"), null);
	}

	private ITileBlock getDoubleCornerLeft() {
		return new TileBlock(3, 3, null, null, findTile("UpperRightInnerCorner12"), null, findTile("DoubleCornerLeft11"), findTile("DoubleCornerLeft12"), null, findTile("DoubleCornerLeft21"), findTile("DoubleCornerLeft22"));
	}

	private ITileBlock getFloorPattern() {
		return new TileBlock(3, 2, findTile("Floor12"), findTile("Floor13"), findTile("Floor14"), findTile("Floor22"), findTile("Floor23"), findTile("Floor24"));
	}
	...
	private ITileBlock getLowerLeftOuterCorner() {
		return new TileBlock(2, 3, findTile("LowerLeftOuterCorner11"), findTile("LowerLeftOuterCorner12"), findTile("LowerLeftOuterCorner21"), findTile("LowerLeftOuterCorner22"), findTile("LowerLeftOuterCorner31"), findTile("LowerLeftOuterCorner32"));
	}

	private ITileBlock getLowerRightOuterCorner() {
		return new TileBlock(2, 3, findTile("LowerRightOuterCorner11"), findTile("LowerRightOuterCorner12"), findTile("LowerRightOuterCorner21"), findTile("LowerRightOuterCorner22"), findTile("LowerRightOuterCorner31"), findTile("LowerRightOuterCorner32"));
	}
	...
	private ITileBlock getUpperRightInnerCorner() {
		return new TileBlock(2, 3, findTile("UpperRightInnerCorner11"), findTile("UpperRightInnerCorner12"), findTile("UpperRightInnerCorner21"), findTile("UpperRightInnerCorner22"), findTile("UpperRightInnerCorner31"), findTile("UpperRightInnerCorner32"));
	}

	private ITileBlock getUpperLeftInnerCorner() {
		ITile[] tiles = { findTile("UpperLeftInnerCorner11"), findTile("UpperLeftInnerCorner12"), findTile("UpperLeftInnerCorner21"), findTile("UpperLeftInnerCorner22"), findTile("UpperLeftInnerCorner31"), findTile("UpperLeftInnerCorner32") };
		return new TileBlock(2, 3, tiles);
	}

	private ITileBlock getUpperRightOuterCorner() {
		return new TileBlock(2, 2, findTile("UpperRightOuterCorner11"), findTile("UpperRightOuterCorner12"), findTile("UpperRightOuterCorner21"), findTile("UpperRightOuterCorner22"));
	}

	private ITileBlock getUpperLeftOuterCorner() {
		return new TileBlock(2, 2, findTile("UpperLeftOuterCorner11"), findTile("UpperLeftOuterCorner12"), findTile("UpperLeftOuterCorner21"), findTile("UpperLeftOuterCorner22"));
	}
